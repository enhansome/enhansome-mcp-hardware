...
* [ros-mcp-server](https://github.com/robotmcp/ros-mcp-server) ⭐ 1,408 | 🐛 61 | 🌐 Python | 📅 2026-08-20 - Connect AI models like Claude & GPT with robots using MCP and ROS.
...
* [embedded-debugger-mcp](https://github.com/Adancurusul/embedded-debugger-mcp) ⭐ 151 | 🐛 0 | 🌐 Rust | 📅 2026-07-16 - A MCP server for embedded debugging with probe-rs.
...
* [robot-mcp-client](https://github.com/robotmcp/robot-mcp-client) ⭐ 14 | 🐛 8 | 🌐 Python | 📅 2026-08-20 - Connect AI models like Claude & GPT with robots using MCP and ROS.
